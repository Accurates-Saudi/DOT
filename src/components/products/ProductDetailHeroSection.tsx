    ...
    >
      <Container size="wide">
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
          <div className="overflow-hidden rounded-2xl border border-[#0c1524]/8 bg-white p-1.5 shadow-[0_12px_40px_-24px_rgba(12,21,36,0.16)] sm:p-2 lg:order-2">
            <div className="aspect-[4/3] overflow-hidden rounded-[0.75rem] sm:rounded-xl lg:aspect-square">
              <img
          ...
          <div className="lg:order-1">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <Button
                ...
                asChild
              >
                <Link to={content.ctaCatalog.href}>
                  <Download className="size-4" />
                  {content.ctaCatalog.label}
                </Link>
              </Button>
            </div>
          </div>
