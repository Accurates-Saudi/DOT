    ...
    >
      <article>
        ...
        <div className="px-3 py-4 sm:px-4 sm:py-5">
          ...
          <span className="text-link-hover text-link-arrow mt-3 inline-flex items-center gap-1 text-[0.6875rem] font-semibold tracking-wide text-[#0c1524] uppercase group-hover/card:text-[#F68E05] sm:text-xs">
            {viewProductLabel}
