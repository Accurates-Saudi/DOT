...
export const aboutPageContent: AboutPageContent = {
  ...
  companyOverview: {
    ...
    heading: "Who We Are",
    body: [
      "DOT is a Saudi-based manufacturer of drilling tools, pipe threaders, high-performance screens, strainers, and filtration solutions engineered for demanding oil & gas and industrial applications.",
